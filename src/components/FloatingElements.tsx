  ...
  return (
    <>
      ...
      <a
        ...
        className="group fixed bottom-6 right-6 z-50 bg-green-500 hover:bg-green-600 text-white p-4 hover:px-8 hover:py-4 rounded-full hover:rounded-2xl shadow-lg hover:shadow-2xl transform hover:scale-110 transition-all duration-500 animate-bounce hover:animate-none glow-cyan hover-lift pulse-glow overflow-hidden flex items-center"
        aria-label="Contact via WhatsApp"
      >
        {/* WhatsApp Icon */}
        <svg className="w-6 h-6 group-hover:mr-3 transition-all duration-300" viewBox="0 0 24 24" fill="currentColor">
